...
my_model = torchvision.models.resnet18(num_classes=10)
...
optimizer = SSM(my_model.parameters(), lr=1, weight_decay=0.0001,momentum=0.9, testfreq=len(trainloader), mode = 'loss with smooth', var_mode='mb', tolerance = 0.005, minN_stats=100)
...
file = open("SSM_Resnet18_minstat100_tol0.005_mb_smooth.txt","x")
