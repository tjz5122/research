...
optimizer = SSM(my_model.parameters(), lr=1, weight_decay=0.0001,momentum=0.9, testfreq=len(trainloader), mode = 'loss with smooth', var_mode='olbm', tolerance = 0.01, minN_stats=100)
...
file = open("SSM_2222Mgnet256_minstat100_tol001_olbm_smooth.txt","x")
