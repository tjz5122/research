...
optimizer = SSM(my_model.parameters(), lr=1, weight_decay=0.0001,momentum=0.9, testfreq=len(trainloader), mode = 'loss', var_mode='mb', tolerance = 0.01, minN_stats=50)
...
file = open("SSM_Resnet18_minstat50_tol001_mb_pure.txt","x")
