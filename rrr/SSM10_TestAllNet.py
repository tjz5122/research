    ...
    for leakratio in leakratio_list:
        for samplefreq in samplefreq_list:
            for trun in trun_list:
                ...
                f.write("ssm10_lk{}_sf{}_tr{}".format(leakratio,samplefreq,trun) + my_model +"_testacculist = {}\n".format(test_accuracy_list))
                f.write("ssm10_lk{}_sf{}_tr{}".format(leakratio,samplefreq,trun) + my_model +"_lrlist = np.log10(np.array({}))\n".format(lr_list))
                '''
                f.write("ssm10_lk={}_sf={}_tr={}".format(leakratio,samplefreq,trun) + my_model +"_statlist = {}\n".format(statistic_list))
                f.write("ssm10_lk={}_sf={}_tr={}".format(leakratio,samplefreq,trun) + my_model +"_losslist = {}\n".format(avg_loss_list))
                f.write("ssm10_lk={}_sf={}_tr={}".format(leakratio,samplefreq,trun) + my_model +"_time = {}\n".format(time))
                f.write("ssm10_lk={}_sf={}_tr={}".format(leakratio,samplefreq,trun) + my_model +"_maxtestaccu = {}\n".format(max_test_accuarcy))
                f.write("ssm10_lk={}_sf={}_tr={}".format(leakratio,samplefreq,trun) + my_model +"_peakepoch = {}\n".format(peak_epoch))
                f.write("ssm10_lk={}_sf={}_tr={}".format(leakratio,samplefreq,trun) + my_model +"_totalparam = {}\n".format(total_parameter))
