# -*- coding: utf-8 -*-
"""
Created on Mon Mar 15 02:35:50 2021
...
for i in range(len(optimizer.param_groups)):
    optimizer.param_groups[i]['lr'] = test_param_groups["lr_group"][i]
    optimizer.param_groups[i]['weight_decay'] = test_param_groups["wd_group"][i]

    


# flexible
chosen_param_groups = ["lr_group","wd_group","batch_size_group","trail_group"]
